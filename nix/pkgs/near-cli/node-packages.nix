...
let
  sources = {
    ...
    "@types/node-18.6.2" = {
      ...
      version = "18.6.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-18.6.2.tgz";
        sha512 = "KcfkBq9H4PI6Vpu5B/KoPeuVDAbmi+2mDBqGPGUgoL7yXQtcWGu2vJWmmRkneWK3Rh0nIAX192Aa87AqKHYChQ==";
      };
    };
