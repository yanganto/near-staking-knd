...
let
  sources = {
    ...
    "@types/node-20.2.0" = {
      ...
      version = "20.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-20.2.0.tgz";
        sha512 = "3iD2jaCCziTx04uudpJKwe39QxXgSUnpxXSvRQjRvHPxFQfmfP4NXIm/NURVeNlTCc+ru4WqjYGTmpXrW9uMlw==";
      };
    };
