...
let
  sources = {
    ...
    "node-abi-3.46.0" = {
      ...
      version = "3.46.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/node-abi/-/node-abi-3.46.0.tgz";
        sha512 = "LXvP3AqTIrtvH/jllXjkNVbYifpRbt9ThTtymSMSuHmhugQLAWr99QQFTm+ZRht9ziUvdGOgB+esme1C6iE6Lg==";
      };
    };
