...
let
  sources = {
    ...
    "@types/node-18.0.4" = {
      ...
      version = "18.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-18.0.4.tgz";
        sha512 = "M0+G6V0Y4YV8cqzHssZpaNCqvYwlCiulmm0PwpNLF55r/+cT8Ol42CHRU1SEaYFH2rTwiiE1aYg/2g2rrtGdPA==";
      };
    };
